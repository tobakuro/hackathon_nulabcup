...
- [x] **[5-1] ゲームルームと進行ループの実装** (Go `select` & `channel`)
- [x] **[5-2] ターン開始・出題イベント** (`ev_turn_start`)
- [x] **[5-3] 「じぶんにヌーを掛ける」ベット処理** (`act_bet_gnu`)
- [x] **[5-4] 回答受付・勝敗・ポイント計算処理** (`act_submit_answer`)
- [x] **[5-5] ターン結果・Tips送信** (`ev_turn_result`)
- [x] **[5-6] 試合終了・リザルト処理** (`ev_game_end`)
- [x] **[5-7] 切断時のTKO処理**（WebSocket `onClose` ハンドリング）
